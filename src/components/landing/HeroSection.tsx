        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-3xl font-extrabold text-primary-foreground leading-tight mb-5 md:text-6xl">
              El sistema financiero no está diseñado para emprendedores tradicionales.
            </h1>
            ...
            {/* CTA Button */}
            <a href="https://chat.whatsapp.com/GHiICK51yboHvarbRh7iOw" target="_blank" rel="noopener noreferrer" className="inline-block rounded-full bg-secondary px-8 py-3 font-bold text-secondary-foreground shadow-lg hover:opacity-90 transition-opacity text-base mb-3">
              Quiero entrar
            </a>
